...
En: http://localhost:9090/graph Consulta métricas como:
...
```bash
 python data/scripts/generate_traffic.py
```

---

**🏆 ¡Felicidades! Has configurado exitosamente el monitoreo de tu modelo.**
